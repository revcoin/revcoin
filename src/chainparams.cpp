...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("04945f1d4fd94e92c95c4979851ce5b7dbee03a940341c5bb52b9ce6170efde6afef7589d9fc3dfb5e550966ea4079627359bc8d3f11194c2b8394d4dfda0b2e2e");
        nDefaultPort = 7571;
        nRPCPort = 7572;
        ...
        //
        // CBlock(hash=000000000019d6, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=4a5e1e, nTime=1467468006, nBits=1d00ffff, nNonce=0, vtx=1)
        //   CTransaction(hash=4a5e1e, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        //     CTxIn(COutPoint(000000, -1), coinbase 04ffff001d0104455468652054696d65732030332f4a616e2f32303039204368616e63656c6c6f72206f6e206272696e6b206f66207365636f6e64206261696c6f757420666f722062616e6b73)
        //     CTxOut(nValue=50.00000000, scriptPubKey=0x5F1DF16B2B704C8A578D0B)
        //   vMerkleTree: 4a5e1e
        const char* pszTimestamp = "Revcoin starting 30 07 2016 backed by the EU group";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1467468006;
        genesis.nBits    = 0x1d00ffff;
        genesis.nNonce   = 1582349777;
...
public:
    CTestNetParams() {
        ...
        vAlertPubKey = ParseHex("044e042521656673483b350153f62ee42e8d260ad37cb7ec91afcd90fc8c7b9626b23cfdb99d5db6f16fa4a81bdcae5ee59f69a6acd40f654a5a2a14f41ff5e704");
        nDefaultPort = 17571;
        nRPCPort = 17572;
        strDataDir = "testnet3";
